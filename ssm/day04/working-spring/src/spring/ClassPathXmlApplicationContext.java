...
public class ClassPathXmlApplicationContext implements ApplicationContext{
	...
	public void init() {		
		...
		BeanDefined userdb = new BeanDefined();
		userdb.setBeanName("user");
		userdb.setClassName("cn.tedu.pojo.User");	
		
		beanDefinedList.add(userdb);		//把上面bean定义添加到list集合中	
		
		BeanDefined deptdb = new BeanDefined();
		deptdb.setBeanName("dept");
		deptdb.setClassName("cn.tedu.pojo.Dept");	
		
		beanDefinedList.add(deptdb);		//把上面bean定义添加到list集合中	
	}
